...
public class Socks5DatagramSocket extends DatagramSocket {
   ...
   */
  protected static final Logger logger = Logger.getLogger(Socks5DatagramSocket.class);
  ...
  public Socks5DatagramSocket(SocksProxy proxy) throws SocksException, IOException {
    ...
    //logger.debug("build datagram socket at[{}:{}]".format(this.getLocalAddress(), this.getLocalPort()));
